...
data_keys = ['pair_name','ti_buy','ti_sell','ma_buy','ma_sell','S1','S2','S3',
             'pivot','R1','R2','R3','percent_bullish','percent_bearish']
...
def investing_com():
    ...
    for pair_id in range(1,12):
        for tf in list(3600,86400):
            data.append(investing_com_fetch(pair_id,tf))
            time.sleep(0.5)
